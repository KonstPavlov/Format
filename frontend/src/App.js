...
export default function App() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    // Prepare payoad matching LeadCreate schema in server.py
    const payload = {
      name: formData.name,
  ...
  const allFilterTags = ["Все", "Капитальный", "Дизайнерский", "Косметический", "Санузел", "ЖК Авиатор"];

  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white selection:bg-amber-500 selection:text-black luxury-grid">
      
      {/* 1. Header (Sticky) */}
      <header 
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
          scrolled ? "bg-black/90 backdrop-blur-xl border-b border-white/10 py-4 shadow-2xl" : "bg-transparent py-6 border-b border-white/5"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              {/* Architectural Outline Building Logo */}
              <div className="w-9 h-9 bg-amber-500 flex items-center justify-center font-black text-black text-xl tracking-tighter">
                Ф
              </div>
              <div className="flex flex-col">
                <span className="font-heading font-black text-xl tracking-wider leading-none text-white group-hover:text-amber-500 transition-colors">
                  ФОРМАТ
                </span>
            ...
            <div className="hidden md:flex items-center gap-2 text-zinc-400 text-xs tracking-wider bg-zinc-900 border border-white/5 px-3 py-1.5 uppercase font-medium">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm uppercase tracking-widest font-semibold text-zinc-400">
          ...
          <div className="hidden sm:flex items-center gap-6">
            <div className="flex flex-col items-end">
              <a 
                ...
                className="font-heading font-bold text-base text-white hover:text-amber-500 transition-colors flex items-center gap-1.5"
                data-testid="header-phone-link"
              >
                <Phone className="w-4 h-4 text-amber-500 animate-pulse" />
                <span>{CONTACTS.phone}</span>
              </a>
              <span className="text-[10px] text-zinc-500 uppercase tracking-widest">Иркутск • Без выходных</span>
            </div>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-[73px] left-0 w-full bg-black/95 backdrop-blur-2xl border-b border-white/10 z-45 py-8 px-6 lg:hidden"
          >
            <div className="flex flex-col gap-6 text-center text-base uppercase tracking-widest font-bold text-zinc-300">
              ...
              <a 
                href={CONTACTS.phoneRaw} 
                className="font-heading font-bold text-lg text-white hover:text-amber-500 transition-colors flex items-center justify-center gap-2"
      ...
      <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
        ...
        {/* Background Premium Image with Heavy Overlay */}
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.pexels.com/photos/13722886/pexels-photo-13722886.jpeg?auto=compress&cs=tinysrgb&w=1920" 
            alt="Премиальный интерьер ФОРМАТ" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            <div className="inline-flex items-center gap-2 text-amber-500 font-heading text-xs font-bold tracking-[0.25em] uppercase border border-amber-500/20 bg-amber-500/5 px-3 py-1.5">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Премиальный ремонт квартир в Иркутске</span>
            </div>

            <h1 className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-none text-white uppercase">
              Ремонт квартир <br />
            ...
            <p className="font-body text-base sm:text-lg text-zinc-300 max-w-xl leading-relaxed">
            ...
            <div className="grid sm:grid-cols-3 gap-4 py-2 border-y border-white/5">
              <div className="flex items-center gap-2.5 text-sm text-zinc-200">
                <div className="w-5 h-5 bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 font-bold text-xs">✓</div>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <button 
                ...
                className="bg-transparent border border-white/20 hover:border-amber-500 hover:text-amber-500 text-white font-bold uppercase text-xs tracking-wider px-8 py-4.5 transition-all duration-300 font-heading"
            ...
            <div className="flex flex-wrap items-center gap-x-8 gap-y-4 text-xs tracking-wider pt-4 text-zinc-400">
              <a 
                href={CONTACTS.phoneRaw} 
          ...
          {/* Quick Stats Sidebar (Right side, Swiss high contrast aesthetic) */}
          <div className="lg:col-span-5 bg-zinc-950/90 border border-white/10 p-8 text-left space-y-8 relative overflow-hidden backdrop-blur-md">
            <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full filter blur-3xl pointer-events-none"></div>
            
            <h3 className="font-heading font-black text-xl tracking-tight text-white uppercase border-b border-white/10 pb-4">
              Бригада Дианова Дмитрия
            </h3>

            <div className="space-y-6">
              <div>
                <span className="text-zinc-500 text-[10px] uppercase tracking-widest block mb-1">Руководитель</span>
                <span className="text-lg font-bold text-white block">{CONTACTS.leader}</span>
                <a href={CONTACTS.phoneRaw} className="text-amber-500 text-sm hover:underline block mt-0.5">{CONTACTS.phone}</a>
              </div>

              <div>
                <span className="text-zinc-500 text-[10px] uppercase tracking-widest block mb-1">Бригадир</span>
                <span className="text-lg font-bold text-white block">{CONTACTS.brigadier}</span>
                <a href={CONTACTS.brigadierPhoneRaw} className="text-amber-500 text-sm hover:underline block mt-0.5">{CONTACTS.brigadierPhone}</a>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <span className="text-[10px] text-zinc-400 uppercase tracking-wider">Лет опыта мастеров</span>
                </div>
                <div>
                  <span className="text-3xl font-heading font-black text-amber-500 block">100%</span>
                  <span className="text-[10px] text-zinc-400 uppercase tracking-wider">Точность сметы</span>
                </div>
              </div>
            </div>

            <div className="bg-amber-500/10 border border-amber-500/20 p-4 text-center">
              <span className="text-xs text-amber-400 font-bold uppercase tracking-wider block mb-1">🔥 Скидка для жильцов</span>
              <span className="text-base font-extrabold text-white block">ЖК АВИАТОР</span>
            </div>
      ...
      <section id="about-section" className="py-24 sm:py-32 border-t border-white/5 relative bg-[#0D0D0D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Почему выбирают нас</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ADVANTAGES.map((adv, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="bg-[#141414] border border-white/5 p-8 relative group hover:border-amber-500/30 transition-all duration-300 hover:-translate-y-1"
                  data-testid={`advantage-card-${index}`}
                >
                  <div className="w-12 h-12 bg-zinc-900 border border-white/10 flex items-center justify-center text-amber-500 mb-6 group-hover:bg-amber-500 group-hover:text-black transition-all duration-300">
                    <IconComp className="w-5 h-5" />
                  </div>
                  <h3 className="font-heading font-bold text-lg text-white mb-3 uppercase tracking-tight">
                    {adv.title}
                  </h3>
      ...
      {/* 4. Pricing (Стоимость) */}
      <section id="pricing-section" className="py-24 sm:py-32 border-t border-white/5 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Стоимость услуг</span>
            <h2 className="font-heading font-black text-3xl sm:text-4xl uppercase tracking-tight text-white leading-none">
            ...
            {PRICING_CARDS.map((card) => (
              <div 
                ...
                className={`flex flex-col justify-between p-8 border ${
                  card.accent 
                    ? "bg-[#141414] border-amber-500 shadow-xl relative" 
                    : "bg-[#141414] border-white/5 hover:border-white/20 transition-all duration-300"
                }`}
              ...
              >
                ...
                <div>
                  ...
                  <div className="border-y border-white/10 py-6 mb-8 text-left">
                    <span className="text-zinc-400 text-xs block uppercase tracking-widest mb-1">Базовая стоимость</span>
                    <span className="text-3xl sm:text-4xl font-heading font-black text-amber-500">
                      {card.price}
                    </span>
                  </div>

                  <ul className="space-y-4 mb-8 text-left text-sm text-zinc-300 font-body">
                ...
                <button 
                  ...
                  className={`w-full py-4 uppercase text-xs tracking-wider font-bold transition-all duration-300 ${
                    card.accent 
                      ? "bg-amber-500 hover:bg-amber-600 text-black" 
                      : "bg-transparent border border-white/20 text-white hover:border-amber-500 hover:text-amber-500"
                  }`}
      ...
      {/* 5. Services Section */}
      <section id="services-section" className="py-24 sm:py-32 border-t border-white/5 bg-[#0D0D0D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Что мы умеем</span>
            <h2 className="font-heading font-black text-3xl sm:text-4xl uppercase tracking-tight text-white leading-none">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((service) => (
              <div 
                key={service.id} 
                className="bg-[#141414] border border-white/5 p-6 flex items-start gap-5 hover:border-amber-500/20 hover:bg-zinc-900 transition-all duration-300 group"
                data-testid={`service-item-${service.id}`}
              >
                <div className="w-12 h-12 bg-[#1F1F1F] flex items-center justify-center text-amber-500 group-hover:bg-amber-500 group-hover:text-black transition-all duration-300 shrink-0">
                  {renderServiceIcon(service.icon, { className: "w-5 h-5" })}
                </div>
                <div className="text-left space-y-2">
                  <h3 className="font-heading font-bold text-base text-white uppercase tracking-tight group-hover:text-amber-400 transition-colors">
                    {service.title}
                  </h3>
      ...
      <section id="portfolio-section" className="py-24 sm:py-32 border-t border-white/5 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="text-left space-y-4 max-w-xl">
              <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Наши работы</span>
              <h2 className="font-heading font-black text-3xl sm:text-4xl uppercase tracking-tight text-white leading-none">
                Выполненные объекты
              </h2>
          ...
          {/* Tetris/Bento Grid for images */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPortfolio.map((item, index) => (
              <div 
                key={item.id}
                onClick={() => setSelectedPhoto(item)}
                className="bg-[#141414] border border-white/5 overflow-hidden group cursor-pointer relative"
              ...
              >
                ...
                <div className="p-6 text-left space-y-2">
                  <div className="flex flex-wrap gap-1.5">
                    {item.tags.map((tag, i) => (
                      <span key={i} className="text-[9px] uppercase tracking-wider text-amber-500 border border-amber-500/20 bg-amber-500/5 px-2 py-0.5">
                        {tag}
                      </span>
                    ))}
                  </div>
                  <h3 className="font-heading font-bold text-base text-white group-hover:text-amber-400 transition-colors uppercase tracking-tight">
                    {item.title}
                  </h3>
        ...
        {selectedPhoto && (
          ...
          >
            <motion.div 
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-[#141414] border border-white/10 max-w-4xl w-full text-left relative overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              <button 
                className="absolute top-4 right-4 bg-black/60 p-2.5 text-zinc-400 hover:text-white border border-white/10 hover:bg-black transition-colors z-10"
                onClick={() => setSelectedPhoto(null)}
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-wrap gap-2">
                      {selectedPhoto.tags.map((tag, i) => (
                        <span key={i} className="text-[10px] uppercase tracking-wider text-amber-500 border border-amber-500/20 bg-amber-500/5 px-2.5 py-1">
                          {tag}
                        </span>
                      ))}
                    </div>
      ...
      <section className="py-24 sm:py-32 border-t border-white/5 bg-[#0D0D0D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Как мы работаем</span>
            <h2 className="font-heading font-black text-3xl sm:text-4xl uppercase tracking-tight text-white leading-none">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12 relative">
            {STAGES.map((stage, i) => (
              <div 
                key={i} 
                className="text-left space-y-4 border-l border-white/10 pl-6 relative"
                data-testid={`stage-card-${i}`}
              >
                <span className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl text-amber-500/20 absolute -top-4 right-0 pointer-events-none">
                  {stage.step}
                </span>
                <span className="text-amber-500 font-heading font-extrabold text-xs uppercase tracking-wider block">
                  Шаг {stage.step}
                </span>
      ...
      <section id="calculator-section" className="py-24 sm:py-32 border-t border-white/5 bg-[#0A0A0A] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            
            {/* Calculator Control Panel (Left Side) */}
            <div className="lg:col-span-7 bg-[#141414] border border-white/10 p-8 sm:p-10 space-y-8 text-left">
              
              <div className="space-y-2">
                <span className="text-[10px] font-bold tracking-[0.25em] uppercase text-amber-500 block">Калькулятор ремонта</span>
                <h2 className="font-heading font-black text-2xl sm:text-3xl uppercase tracking-tight text-white leading-none">
              ...
              <div className="space-y-3">
                <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">1. Тип помещения</label>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">2. Площадь помещения</label>
                  <div className="flex items-center bg-zinc-900 border border-white/10 px-3 py-1">
                    <input 
                      type="number" 
                      min="10" 
                      max="300"
                      ...
                      className="bg-transparent text-white font-heading font-bold text-sm w-12 text-right focus:outline-none border-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                      data-testid="calc-area-input"
                    />
                    <span className="text-xs text-zinc-500 ml-1 font-bold">м²</span>
                  </div>
                </div>

                <div className="flex items-center gap-4">
                  <span className="text-xs text-zinc-500">10 м²</span>
                  <input 
                    type="range" 
                    min="10" 
                    max="200" 
                    ...
                    className="w-full h-1 bg-zinc-800 accent-amber-500 cursor-pointer"
                    data-testid="calc-area-slider"
                  />
                  <span className="text-xs text-zinc-500">200 м²</span>
                </div>
              </div>

              {/* Repair Type selection */}
              <div className="space-y-3">
                <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">3. Вид ремонта</label>
                <div className="grid sm:grid-cols-3 gap-2">
                  {[
                    ...
                    >
                      <span className="uppercase text-[10px] tracking-wider font-extrabold block mb-1">
                        {type.name}
                      </span>
                      <span className={`text-[9px] ${calcRepairType === type.id ? "text-black/70" : "text-zinc-500"}`}>
                        {type.price}
                      </span>
                    </button>
                  ))}
              ...
              <div className="space-y-3">
                <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">4. Дополнительные работы</label>
                    ...
                    >
                      <div 
                        className={`w-4.5 h-4.5 flex items-center justify-center border ${
                          calcAddons.includes(addon.id) ? "border-amber-500 bg-amber-500 text-black" : "border-white/20"
                        }`}
                        data-testid={`calc-addon-${addon.id}`}
                      >
                        {calcAddons.includes(addon.id) && <Check className="w-3 h-3 stroke-[3]" />}
                      </div>
                      <span className="text-zinc-300 font-body select-none">{addon.name}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Price Output panel (Right Side, expensive visual) */}
            <div className="lg:col-span-5 bg-gradient-to-br from-zinc-950 to-zinc-900 border border-amber-500/30 p-8 sm:p-10 space-y-8 text-left relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full filter blur-3xl pointer-events-none"></div>

              <div className="space-y-1">
                <span className="text-zinc-500 text-[10px] uppercase tracking-widest block">Ориентировочная сметная стоимость</span>
                ...
                <span className="text-[10px] text-zinc-500 uppercase tracking-widest block pt-2 border-t border-white/5">
      ...
      <section className="py-24 sm:py-32 border-t border-white/5 bg-[#0D0D0D]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Отзывы клиентов</span>
            <h2 className="font-heading font-black text-3xl sm:text-4xl uppercase tracking-tight text-white leading-none">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t, idx) => (
              <div 
                key={idx} 
                className="bg-[#141414] border border-white/5 p-8 relative flex flex-col justify-between"
                data-testid={`testimonial-card-${idx}`}
              >
                {/* Large architectural Quote mark behind */}
                <span className="text-[120px] font-black text-white/5 absolute -top-8 -left-2 pointer-events-none select-none">
                  “
                </span>
                ...
                <div className="space-y-6 relative z-10 text-left">
                  ...
                  <p className="text-zinc-300 font-body text-sm leading-relaxed italic">
                    &ldquo;{t.text}&rdquo;
                  </p>
                </div>

                <div className="border-t border-white/5 pt-6 mt-8 flex justify-between items-center relative z-10 text-left">
                  <div>
                    <h4 className="font-heading font-bold text-sm text-white uppercase tracking-tight">{t.name}</h4>
                    <p className="text-[10px] text-zinc-500 uppercase tracking-widest mt-0.5">{t.project}</p>
                  </div>
      ...
      <section id="faq-section" className="py-24 sm:py-32 border-t border-white/5 bg-[#0A0A0A]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          
          <div className="text-center mb-16 space-y-4">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Часто задаваемые вопросы</span>
            <h2 className="font-heading font-black text-3xl uppercase tracking-tight text-white leading-none">
            ...
            {FAQ_ITEMS.map((faq, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="font-heading font-bold text-base text-white group-hover:text-amber-400 transition-colors uppercase tracking-tight">
                      {faq.question}
                    </span>
                    <ChevronDown className={`w-5 h-5 text-zinc-500 group-hover:text-amber-500 transition-transform duration-300 shrink-0 ${
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p 
                          className="pb-6 text-sm text-zinc-400 leading-relaxed font-body"
      ...
      <section id="contact-form-section" className="py-24 sm:py-32 border-t border-white/5 bg-[#0D0D0D] relative">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.pexels.com/photos/34573691/pexels-photo-34573691.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" 
            alt="Чертеж" 
            className="w-full h-full object-cover filter brightness-[0.03]"
          />
        </div>

        <div className="relative z-10 max-w-xl mx-auto px-4 sm:px-6">
          
          <div className="bg-[#141414] border border-white/10 p-8 sm:p-12 space-y-8 text-left shadow-2xl">
            
            <div className="text-center space-y-3">
              <span className="text-xs font-bold tracking-[0.25em] uppercase text-amber-500 block">Свяжитесь с нами</span>
              <h2 className="font-heading font-black text-2xl sm:text-3xl uppercase tracking-tight text-white leading-none">
            ...
            {formSubmitted ? (
              ...
              >
                <div className="w-16 h-16 bg-amber-500/20 border border-amber-500 flex items-center justify-center text-amber-500 rounded-full mx-auto">
                ...
                <button
                  ...
                  className="text-xs text-amber-500 underline font-semibold tracking-wider hover:text-amber-400 transition-colors uppercase pt-2"
                >
              ...
              <form onSubmit={handleFormSubmit} className="space-y-6">
                ...
                {formError && (
                  <div className="bg-red-500/10 border border-red-500/30 p-4 text-xs text-red-400 font-semibold" data-testid="lead-form-error">
                    {formError}
                  </div>
                )}

                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold block">Ваше имя *</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-[#0A0A0A] border border-white/10 px-4 py-3 text-sm text-white focus:outline-none focus:border-amber-500 transition-all font-body"
                    data-testid="lead-form-name-input"
                  />
                </div>

                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold block">Ваш телефон *</label>
                  <input
                    type="tel"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold block">Комментарий к заявке</label>
                  <textarea
                    rows="3"
                    placeholder="Укажите ЖК, площадь или тип требуемых работ..."
                    value={formData.comment}
                    onChange={(e) => setFormData({ ...formData, comment: e.target.value })}
                    className="w-full bg-[#0A0A0A] border border-white/10 px-4 py-3 text-sm text-white focus:outline-none focus:border-amber-500 transition-all font-body resize-none"
                ...
                <button
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-600 disabled:bg-zinc-800 disabled:text-zinc-600 text-black font-black uppercase text-xs tracking-widest py-4 transition-all duration-300 font-heading"
      ...
      {/* 12. Footer */}
      <footer className="bg-black border-t border-white/10 py-16 text-zinc-400 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
            ...
            <div className="md:col-span-4 space-y-4 text-left">
              ...
              >
                <div className="w-8 h-8 bg-amber-500 flex items-center justify-center font-black text-black text-lg tracking-tighter">
                  Ф
                </div>
            ...
            <div className="md:col-span-4 text-left space-y-4">
              ...
              <div className="space-y-3 text-xs font-body">
                ...
                <div className="text-[10px] text-zinc-500 pt-2 border-t border-white/5 uppercase tracking-widest">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between text-[10px] text-zinc-500 gap-4 font-body">
            ...
            <div className="flex gap-6">
              <a href="/privacy" className="hover:underline hover:text-zinc-300">Политикой конфиденциальности</a>
              <a href="/consent" className="hover:underline hover:text-zinc-300">Согласие на обработку персональных данных</a>
            </div>
          </div>
      ...
      <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3 pointer-events-none">
        ...
        <a 
          ...
          target="_blank"
          rel="noreferrer"
          className="w-12 h-12 bg-zinc-950 border border-white/20 hover:border-amber-500 text-amber-500 hover:text-amber-400 shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 pointer-events-auto"
